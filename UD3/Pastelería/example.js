...
$('#popoverimage2').popover({ trigger: "hover" });
$('#popoverimage3').popover({ trigger: "hover" });
...
$('darkMode').click(function() {
  $('.nav-link').removeClass('text-body').addClass('text-light');
  $(this).addClass('text-light').removeClass('text-body');
});
